package com.hsaffiliate.aquahunter.ui.legal
...
const val MARITIME_RISK_NOTICE_VERSION = "2026-07-19"
...
val maritimeRiskSections = listOf(
    MaritimeRiskSection(
        "1. Intelligence service—not navigation, detection or professional advice",
    ...
    MaritimeRiskSection(
        "2. Weather, ocean and fish movement risk",
    ...
    MaritimeRiskSection(
        "3. Vessel charter, fleet service and hiring",
    ...
    MaritimeRiskSection(
        "4. Master, operator and user responsibility",
    ...
    MaritimeRiskSection(
        "5. Piracy, armed robbery, conflict and security",
    ...
    MaritimeRiskSection(
        "6. AIS and vessel-position limitations",
    ...
    MaritimeRiskSection(
        "7. Fishing law, borders, closed areas and IUU fishing",
    ...
    Column(
        ...
        Column(
            ...
            Row(verticalAlignment = Alignment.Top) {
                ...
                Text(
                    "I have read and understand the notice, including safety, fish-probability, vessel, piracy and lawful-fishing limitations.",
                    color = TextPrimary,
                    fontSize = 10.sp,
                    lineHeight = 15.sp,
